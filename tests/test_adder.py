...
from vlsiffra.adder import BrentKung, KoggeStone, HanCarlson, Ripple
...
class TestRippleAdder(Ripple, NoneProcess):
    pass
...
class TestCaseRippleRandom(unittest.TestCase):
    def setUp(self):
        self.bits = 64
        self.dut = TestRippleAdder(self.bits)
